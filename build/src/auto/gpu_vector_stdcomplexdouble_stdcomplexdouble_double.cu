...
template void phaseVector<std::complex<double>, std::complex<double> >(
  ...
  template void addScaledVector<std::complex<double>, std::complex<double>, double >(
    const std::complex<double>* x, const std::complex<double>& scale, const double* y,
    typename promote<typename promote<std::complex<double>, std::complex<double> >::type,
                     double >::type* z,
    unsigned size);

  template void subScaledVector<std::complex<double>, std::complex<double>, double >(
    const std::complex<double>* x, const std::complex<double>& scale, const double* y,
    typename promote<typename promote<std::complex<double>, std::complex<double> >::type,
                     double >::type* z,
    unsigned size);
