...
namespace lowlevel
{
  ...
  template void diff3sym<unsigned >(
      const unsigned dim, const unsigned x_size, const unsigned y_size, const unsigned* x, unsigned* y, unsigned size);
  ...
  template void bdiff3sym<unsigned >(
      const unsigned dim, const unsigned x_size, const unsigned y_size, const unsigned* x, unsigned* y, unsigned size);
