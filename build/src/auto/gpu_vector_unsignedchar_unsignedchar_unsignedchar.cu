...
namespace lowlevel
{
  ...
  template void diff3sym<unsigned char >(
      const unsigned dim, const unsigned x_size, const unsigned y_size, const unsigned char* x, unsigned char* y, unsigned size);
  ...
  template void bdiff3sym<unsigned char >(
      const unsigned dim, const unsigned x_size, const unsigned y_size, const unsigned char* x, unsigned char* y, unsigned size);
