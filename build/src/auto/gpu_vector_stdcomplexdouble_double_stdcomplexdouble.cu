...
#define AGILE_TEXTURE agile_matrix_texture_stdcomplexdoubledouble
texture<agile::to_tuple_type<std::complex<double> >::texture_type> AGILE_TEXTURE;

#define AGILE_TEXTURE_2D agile_matrix_texture_2d_stdcomplexdoubledouble
...
namespace lowlevel
{
  ...
  template void interpolate2d<std::complex<double>, double >(
  ...
  template void pow<std::complex<double>, double>(const std::complex<double>& alpha,
                              const double* x,
  ...
  template void addVector<std::complex<double>, double >(
    const std::complex<double>* x, const double* y,
    typename promote<std::complex<double>, double >::type* z, unsigned size);

  template void divideVector<std::complex<double>, double >(
    const std::complex<double>& alpha, const double* x,
    typename promote<std::complex<double>, double >::type* y, unsigned size);

  template typename promote<std::complex<double>, double >::type getScalarProduct(
    const std::complex<double>* x, const double* y, unsigned size);

  template void multiplyConjElementwise<std::complex<double>, double >(
    const std::complex<double>* x, const double* y,
    typename promote<std::complex<double>, double >::type* z, unsigned size);

  template void multiplyElementwise<std::complex<double>, double >(
    const std::complex<double>* x, const double* y,
    typename promote<std::complex<double>, double >::type* z, unsigned size);

  template void divideElementwise<std::complex<double>, double >(
    const std::complex<double>* x, const double* y,
    typename promote<std::complex<double>, double >::type* z, unsigned size);

  template void scale<std::complex<double>, double >(
    const std::complex<double>& alpha, const double* x,
    typename promote<std::complex<double>, double >::type* y, unsigned size);
    
  template void subVector<std::complex<double>, double >(
    const std::complex<double>* x, const double* y,
    typename promote<std::complex<double>, double >::type* z, unsigned size);
  ...
  template void max<std::complex<double>, double >(
      const std::complex<double>* x1, const double* x2, typename promote<std::complex<double>, double >::type* y, unsigned size);
...
#if TType1IsComplex
#if !TType2IsComplex
template void phaseVector<std::complex<double>, double >(
    const std::complex<double>* x,
    double* y, unsigned size);
#endif  // TType1IsComplex
#endif  // !TType2IsComplex
  ...
  template void addScaledVector<std::complex<double>, double, std::complex<double> >(
    const std::complex<double>* x, const double& scale, const std::complex<double>* y,
    typename promote<typename promote<std::complex<double>, double >::type,
                     std::complex<double> >::type* z,
    unsigned size);

  template void subScaledVector<std::complex<double>, double, std::complex<double> >(
    const std::complex<double>* x, const double& scale, const std::complex<double>* y,
    typename promote<typename promote<std::complex<double>, double >::type,
                     std::complex<double> >::type* z,
    unsigned size);
