...
template void phaseVector<std::complex<double>, double >(
  ...
  template void addScaledVector<std::complex<double>, double, double >(
    const std::complex<double>* x, const double& scale, const double* y,
    typename promote<typename promote<std::complex<double>, double >::type,
                     double >::type* z,
    unsigned size);

  template void subScaledVector<std::complex<double>, double, double >(
    const std::complex<double>* x, const double& scale, const double* y,
    typename promote<typename promote<std::complex<double>, double >::type,
                     double >::type* z,
    unsigned size);
