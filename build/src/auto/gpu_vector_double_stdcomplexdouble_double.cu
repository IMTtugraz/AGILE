...
namespace lowlevel
{
  ...
  template void diff3sym<double >(
      const unsigned dim, const unsigned x_size, const unsigned y_size, const double* x, double* y, unsigned size);
  ...
  template void bdiff3sym<double >(
      const unsigned dim, const unsigned x_size, const unsigned y_size, const double* x, double* y, unsigned size);
...
template void phaseVector<double, std::complex<double> >(
  ...
  template void addScaledVector<double, std::complex<double>, double >(
    const double* x, const std::complex<double>& scale, const double* y,
    typename promote<typename promote<double, std::complex<double> >::type,
                     double >::type* z,
    unsigned size);

  template void subScaledVector<double, std::complex<double>, double >(
    const double* x, const std::complex<double>& scale, const double* y,
    typename promote<typename promote<double, std::complex<double> >::type,
                     double >::type* z,
    unsigned size);
