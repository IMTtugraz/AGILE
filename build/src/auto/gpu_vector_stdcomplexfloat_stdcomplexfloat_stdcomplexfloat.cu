...
namespace lowlevel
{
  ...
  template void interpolate2d<std::complex<float>, std::complex<float> >(
  ...
  template void pow<std::complex<float>, std::complex<float>>(const std::complex<float>& alpha,
                              const std::complex<float>* x,
  ...
  template void addVector<std::complex<float>, std::complex<float> >(
    const std::complex<float>* x, const std::complex<float>* y,
    typename promote<std::complex<float>, std::complex<float> >::type* z, unsigned size);

  template void divideVector<std::complex<float>, std::complex<float> >(
    const std::complex<float>& alpha, const std::complex<float>* x,
    typename promote<std::complex<float>, std::complex<float> >::type* y, unsigned size);

  template typename promote<std::complex<float>, std::complex<float> >::type getScalarProduct(
    const std::complex<float>* x, const std::complex<float>* y, unsigned size);

  template void multiplyConjElementwise<std::complex<float>, std::complex<float> >(
    const std::complex<float>* x, const std::complex<float>* y,
    typename promote<std::complex<float>, std::complex<float> >::type* z, unsigned size);
  ...
  template void divideElementwise<std::complex<float>, std::complex<float> >(
    const std::complex<float>* x, const std::complex<float>* y,
    typename promote<std::complex<float>, std::complex<float> >::type* z, unsigned size);
  ...
  template void subVector<std::complex<float>, std::complex<float> >(
    const std::complex<float>* x, const std::complex<float>* y,
    typename promote<std::complex<float>, std::complex<float> >::type* z, unsigned size);
  ...
  template void max<std::complex<float>, std::complex<float> >(
      const std::complex<float>* x1, const std::complex<float>* x2, typename promote<std::complex<float>, std::complex<float> >::type* y, unsigned size);
...
#if TType1IsComplex
#if !TType2IsComplex
template void phaseVector<std::complex<float>, std::complex<float> >(
    const std::complex<float>* x,
    std::complex<float>* y, unsigned size);
#endif  // TType1IsComplex
#endif  // !TType2IsComplex
  ...
  template void addScaledVector<std::complex<float>, std::complex<float>, std::complex<float> >(
    const std::complex<float>* x, const std::complex<float>& scale, const std::complex<float>* y,
    typename promote<typename promote<std::complex<float>, std::complex<float> >::type,
                     std::complex<float> >::type* z,
    unsigned size);

  template void subScaledVector<std::complex<float>, std::complex<float>, std::complex<float> >(
    const std::complex<float>* x, const std::complex<float>& scale, const std::complex<float>* y,
    typename promote<typename promote<std::complex<float>, std::complex<float> >::type,
                     std::complex<float> >::type* z,
    unsigned size);
