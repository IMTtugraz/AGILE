...
template void phaseVector<double, double >(
  ...
  template void addScaledVector<double, double, std::complex<double> >(
    const double* x, const double& scale, const std::complex<double>* y,
    typename promote<typename promote<double, double >::type,
                     std::complex<double> >::type* z,
    unsigned size);

  template void subScaledVector<double, double, std::complex<double> >(
    const double* x, const double& scale, const std::complex<double>* y,
    typename promote<typename promote<double, double >::type,
                     std::complex<double> >::type* z,
    unsigned size);
