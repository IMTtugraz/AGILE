...
sed -i -e "s!unsigned int test_nr = 0;!unsigned int test_nr = 1;!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
sed -i -e "s!Timer Results!Timer Results 1404/MultiplyMatrixVector/R2C_Float.xls!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
...
sed -i -e "s!unsigned int test_nr = 0;!unsigned int test_nr = 1;!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
sed -i -e "s!Timer Results!Timer Results 1404/MultiplyMatrixVector/R5C_Float.xls!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
...
sed -i -e "s!unsigned int test_nr = 0;!unsigned int test_nr = 1;!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
sed -i -e "s!Timer Results!Timer Results 1404/MultiplyMatrixVector/R10C_Float.xls!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
...
sed -i -e "s!unsigned int test_nr = 0;!unsigned int test_nr = 1;!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
sed -i -e "s!Timer Results!Timer Results 1404/MultiplyMatrixVector/C2R_Float.xls!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
...
sed -i -e "s!unsigned int test_nr = 0;!unsigned int test_nr = 1;!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
sed -i -e "s!Timer Results!Timer Results 1404/MultiplyMatrixVector/C5R_Float.xls!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
...
sed -i -e "s!unsigned int test_nr = 0;!unsigned int test_nr = 1;!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
sed -i -e "s!Timer Results!Timer Results 1404/MultiplyMatrixVector/C10R_Float.xls!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
...
sed -i -e "s!unsigned int test_nr = 0;!unsigned int test_nr = 1;!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
sed -i -e "s!Timer Results!Timer Results 1404/MultiplyMatrixVector/CDouble.xls!" gpu_matrix_vs_gpu_matrix_pitched_float_test.cpp
