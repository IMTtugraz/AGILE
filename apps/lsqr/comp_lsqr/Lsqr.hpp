...
/*typedef struct LSQR_FUNC {     **** Not used in C++ version ***
  void     (*mat_vec_prod) (long, fvec *, fvec *, void *);
} lsqr_func;
*/
...
void fvec_scale( float, fvec * );
void fvec_copy( fvec *, fvec * );
/**
