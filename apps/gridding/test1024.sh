...
DATA_TRANSFORMATION_MATRIX="data/csrmatrix_A_1048576x1048576.bin"
DATA_TRANSFORMATION_MATRIX_ADJOINT="data/csrmatrix_AT_1048576x1048576.bin"
DATA_KSPACE_INPUT_VECTOR="data/vector_kspace_data_1048576(1024x1024).bin"
DATA_KSPACE_POSITION_VECTOR="data/vector_kspace_positions_1048576(1024x1024).bin"

DATA_KSPACE_TEMP_RESULT_VECTOR="res_vector_kspace_data_1048576.bin"
DATA_GSPACE_RESULT_VECTOR="res_vector_gspace_data_1048576.bin"
